package manj.springframework.spring5recipeapp.bootstrap;
...
import manj.springframework.spring5recipeapp.domain.Difficulty;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
	...
	public void onApplicationEvent(ContextRefreshedEvent event) {
		...
		System.out.println("Recipies saved");
	...
	private List<Recipe> getRecipes() {
		...
		Optional<UnitOfMeasure> tablespoonUomOptional = unitOfMeasureRepository.findByDescription("Teaspoon");
